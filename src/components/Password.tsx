...
const Password:FC<PasswordProps> = ({password, setPassword, labelText}) => {
    ...
    return <div className="relative mt-3">
                <input type="password" id="password" value={password} onChange={(e) => { setPassword(e.target.value)}} className="block p-6 w-full text-md text-gray-900 rounded-lg border border-gray-300 appearance-none dark:text-white focus:outline-none focus:ring-0 focus:border-gray-900 peer" placeholder=" " />
